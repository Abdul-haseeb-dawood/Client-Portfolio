    ...
    >
      ...
      <div className=" my-28">
        <div className="card mx-auto">
          <div className="bg">
          <Image src={'/yarooq.png'} alt={'Yarooq'} width={200} height={200}/>
          </div>
        ...
        <div className="relative z-10 flex w-full items-center justify-center px-6">
          ...
          <div className="text-center">
            ...
            >
              Senior JavaScript Engineer | Full-Stack Expert in MEAN, MERN, MEVN, AWS, SQL & NoSQL Databases.
            </p>
            <p
              ref={pRef}
              className="mx-auto mt-4 max-w-2xl md:text-balance text-sm/6 md:text-base/7 font-light tracking-tight text-white/70"
            >
              📧 syed.yarooq1701@gmail.com📞 +49 152 1107 8765
            </p>
